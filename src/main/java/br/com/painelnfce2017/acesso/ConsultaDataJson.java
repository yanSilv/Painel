 ...
 */
@Path("/consultadata")
public class ConsultaDataJson {
    
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    public ArrayList<ModCupom> consultaData(@Context UriInfo info) {
        String data = null;
        String validos = null;
        String contigencia = null;
        
        String bancoDb;
        ArrayList<ModCupom> arrayRet;
        ...
        arrayRet = ctlConsu.consulDataNFCe(bancoDb, data, validos, contigencia);
